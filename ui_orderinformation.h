...
public:
    ...
    void retranslateUi(QDialog *OrderInformation)
    {
        ...
        label_tittle_2->setText(QApplication::translate("OrderInformation", "Film 1 ", 0));
        label_time_2->setText(QApplication::translate("OrderInformation", "19.00", 0));
        label_building_2->setText(QApplication::translate("OrderInformation", "Budynek 1", 0));
        label_numberofticket_2->setText(QString());
        label_allticketsprice_2->setText(QString());
        label_nrreservation_2->setText(QApplication::translate("OrderInformation", "5", 0));
        ...
        label_user_4->setText(QApplication::translate("OrderInformation", "kowalski", 0));

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Reservation_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 40, 38),
QT_MOC_LITERAL(4, 79, 5),
QT_MOC_LITERAL(5, 85, 29)
    },
    "Reservation\0on_pushButton_back_clicked\0"
    "\0on_tableView_reservation_doubleClicked\0"
    "index\0on_pushButton_refresh_clicked\0"
};
...
void Reservation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_tableView_reservation_doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
...
const QMetaObject Reservation::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Reservation.data,
      qt_meta_data_Reservation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Reservation.stringdata))
        return static_cast<void*>(const_cast< Reservation*>(this));
